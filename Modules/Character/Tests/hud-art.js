...
const designs={
 ...
 'ResourcePanel':svg(512,160,`<defs>${metal}<linearGradient id="p" x2="0" y2="1"><stop stop-color="#101722"/><stop offset=".5" stop-color="#070c13"/><stop offset="1" stop-color="#0b111a"/></linearGradient></defs><path d="M2 8H474Q504 8 504 38V122Q504 152 474 152H2Z" fill="url(#p)" stroke="#080a0b" stroke-width="8"/><path d="M2 8H474Q504 8 504 38V122Q504 152 474 152H2" fill="none" stroke="url(#m)" stroke-width="3"/><path d="M18 17H473Q493 17 493 39V121Q493 143 473 143H18" fill="none" stroke="#76603b"/><path d="M488 59L496 80L488 101L481 80Z" fill="#211e17" stroke="#b89a60"/><path d="M486 80L489 74L492 80L489 86Z" fill="#b99b63"/>`),
 // Carte de compétence : mêmes matériaux que le cadre, arrondie des 4 côtés,
 // découpée en 9 parts dans UI_Skills.lua (coins 24/128 de la texture).
 'SkillCard':svg(128,128,`<defs>${metal}<linearGradient id="p" x2="0" y2="1"><stop stop-color="#101722"/><stop offset=".5" stop-color="#070c13"/><stop offset="1" stop-color="#0b111a"/></linearGradient></defs><rect x="4" y="4" width="120" height="120" rx="20" fill="url(#p)" stroke="#080a0b" stroke-width="7"/><rect x="4" y="4" width="120" height="120" rx="20" fill="none" stroke="url(#m)" stroke-width="3"/><rect x="11" y="11" width="106" height="106" rx="13" fill="none" stroke="#76603b"/>`),
 // Losange du cadre, là où le flux de pixels arrive sur la carte.
 'SkillCardGem':svg(32,64,`<defs>${metal}</defs><path d="M16 4L27 32L16 60L5 32Z" fill="#211e17" stroke="#b89a60" stroke-width="1.5"/><path d="M16 22L20 32L16 42L12 32Z" fill="#b99b63"/>`),
