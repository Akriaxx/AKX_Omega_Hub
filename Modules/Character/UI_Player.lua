...
local function MakeGauge(parent, key, y)
    ...
    local tempEB = UI.CreateStyledEditBox(row, 42, 14)
    ...
    local maxEB = UI.CreateStyledEditBox(row, 34, 14)
    ...
    local curEB = UI.CreateStyledEditBox(row, 34, 14)
...
nameText:SetPoint("RIGHT", panel, "RIGHT", -28, 0)
