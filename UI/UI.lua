...
function UI.ApplyBorder(frame)
    local col = (UI.colors and UI.colors.border) or { 0.60, 0.52, 0.28, 1.00 }
    local r, g, b, a = col[1], col[2], col[3], col[4] or 1.00
    ...
    Line("TOPLEFT",     1,  -1, "TOPRIGHT",    -1,  -1, false)
    Line("BOTTOMLEFT",  1,   1, "BOTTOMRIGHT", -1,   1, false)
    Line("TOPLEFT",     1,  -1, "BOTTOMLEFT",   1,   1, true)
    Line("TOPRIGHT",   -1,  -1, "BOTTOMRIGHT", -1,   1, true)
end
